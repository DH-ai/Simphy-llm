    ...
    this.drawCylinder = function(Q, N, P, ad) {
        ...
        for (aa = 0; aa < 15; aa++) {
            ...
            for (S = 0; S < 15; S++) {
                ...
                if (b[U][S]) {
                    ...
                    switch (ac) {
                        case 0:
                            canvas.setFillStyle("rgb(" + ((O * 255) >> 0) + "," + ((O * 0) >> 0) + "," + ((O * 0) >> 0) + ")");
                            break;
                        case 1:
                            canvas.setFillStyle("rgb(" + ((O * 0) >> 0) + "," + ((O * 255) >> 0) + "," + ((O * 0) >> 0) + ")");
                            break;
                        case 2:
                            canvas.setFillStyle("rgb(" + ((O * 0) >> 0) + "," + ((O * 0) >> 0) + "," + ((O * 255) >> 0) + ")");
                            break;
                        case 3:
                            canvas.setFillStyle("rgb(" + ((O * 255) >> 0) + "," + ((O * 255) >> 0) + "," + ((O * 0) >> 0) + ")");
                            break;
                        case 4:
                            canvas.setFillStyle("rgb(" + ((O * 255) >> 0) + "," + ((O * 0) >> 0) + "," + ((O * 255) >> 0) + ")");
                            break;
                        case 5:
                            canvas.setFillStyle("rgb(" + ((O * 0) >> 0) + "," + ((O * 255) >> 0) + "," + ((O * 255) >> 0) + ")");
                            break;
                        case 6:
                            canvas.setFillStyle("rgb(" + ((O * 220) >> 0) + "," + ((O * 220) >> 0) + "," + ((O * 220) >> 0) + ")");
                            break;
                        case 20:
                            canvas.setFillStyle("rgb(" + ((O * 100) >> 0) + "," + ((O * 100) >> 0) + "," + ((O * 100) >> 0) + ")");
                            break;
                        case 30:
                            canvas.setFillStyle("rgb(" + ((O * 190) >> 0) + "," + ((O * 190) >> 0) + "," + ((O * 0) >> 0) + ")");
                            break;
                        default:
                            canvas.setFillStyle("rgb(" + ((O * 220) >> 0) + "," + ((O * 220) >> 0) + "," + ((O * 220) >> 0) + ")");
                            break
                    ...
                    var ab = ((U - R) % 15 + 15) % 15;
                    Game.drawFront(U, X, ab > 3.3 && ab < 10.7, R, (ab > 11.9 || ab < 10.9) && ((V = b[(U + 14) % 15][S]) && V[1] == b[U][S][1]), (ab < 2.1 || ab > 3.1) && ((V = b[(U + 1) % 15][S]) && V[1] == b[U][S][1]), ((V = b[U][S + 1]) && V[1] == b[U][S][1]), ((V = b[U][S - 1]) && V[1] == b[U][S][1]));
                    if (!b[U][S + 1] || (V = ad && ad.contains(S + 1))) {
                        Game.drawTop(U, X, R, ((V || !b[(U + 14) % 15][S + 1]) && (V = b[(U + 14) % 15][S]) && V[1] == b[U][S][1]), ((V || !b[(U + 1) % 15][S + 1]) && (V = b[(U + 1) % 15][S]) && V[1] == b[U][S][1]))
                    }
                    if (ab > 6.5 && ab < 14) {
                        if (!b[((T + 1 + M) % 15 + 15) % 15][S]) {
                            Game.drawSide(U + 1, X, R, ((V = b[U][S + 1]) && V[1] == b[U][S][1]), ((V = b[U][S - 1]) && V[1] == b[U][S][1]))
                        }
                    }
                    if (ab < 7.5) {
                        if (!b[((T - 1 + M) % 15 + 15) % 15][S]) {
                            Game.drawSide(U, X, R, ((V = b[U][S + 1]) && V[1] == b[U][S][1]), ((V = b[U][S - 1]) && V[1] == b[U][S][1]))
                        }
                    }
                }
            }
        ...
        for (aa = 0; aa < 15 && !N; aa++) {
            ...
            if (O > 9) {
                ...
                canvas.setFillStyle("rgb(" + (255 * (Math.sin(new Date() / 200) / 2 + 1 / 2) >> 0) + ",30,0)");
...
(function() {
    ...
    Function.prototype.wait = function() {
        ...
        b = arguments;
        a[a.length] = [this, App.setTimeout(function() {
...
function renderScore(){
    ...
    canvas_score.drawImage(nextblockImg, canvas_score.canvas.width/2-nextblockImg.width/2, 145);
